...
const PRESETS = [
  ...
  {
    name: '藤井風 (Fujii Kaze)',
    liveUrl: 'https://fujiikaze.com/news/',
    selectorItem: 'li.fk-news-archive__item',
    selectorTitle: 'a.fk-news-archive__link',
  ...
  {
    name: 'YOASOBI',
    liveUrl: 'https://www.sonymusic.co.jp/json/v2/artist/YOASOBI/information/list/start/0/count/10',
    selectorItem: 'json',
    selectorTitle: '',
    selectorDate: '',
    selectorVenue: '',
  ...
  },
  {
    ...
    liveUrl: 'https://zutomayo.net/news/',
    selectorItem: '.ztmy-topics',
    selectorTitle: '.ztmy-topics-head h3',
    selectorDate: '.ztmy-topics-head p',
    selectorVenue: '',
    selectorLink: '.ztmy-topics-more a',
  },
  {
    name: 'BREIMEN',
    liveUrl: 'https://www.sonymusic.co.jp/json/v2/PR/breimen-indies/information/list/start/0/count/10',
    selectorItem: 'json',
    selectorTitle: '',
    selectorDate: '',
    selectorVenue: '',
  ...
  {
    name: 'MILLENNIUM PARADE (Natalie - Fallback)',
